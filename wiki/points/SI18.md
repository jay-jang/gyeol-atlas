...
顴髎 · Quanliao · 수태양소장경 · 머리·얼굴

정규 361경혈 중 한 항목 · 모델 표식 2곳. 이름 수와 양측·복수 위치의 표식 수는 다릅니다.

## 위치 참고

얼굴, 광대뼈 아래쪽, 가쪽눈구석에서 수직으로 아래쪽 오목한 곳.

[KMCRIC SI18 위치 원문](https://www.kmcric.com/database/acupoint/SI/SI18); 영문 병기를 간추린 짧은 위치 참고입니다. 전문가 미검수이며 공식 번역이나 3D 좌표 표준이 아닙니다.

## 전통적으로 언급된 용도

눈꺼풀 증상 · 안면 증상. 문헌에 기재된 전통적 용도의 일부를 간추렸습니다. 특정 경혈의 임상 효과가 입증되었다는 뜻은 아닙니다.

[항목별 용도 출처](https://tcmwiki.com/wiki/si18). TCM Wiki의 설명을 한국어로 간추리고 편집했습니다. [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
