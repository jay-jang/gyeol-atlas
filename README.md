...
- BodyParts3D v3.0 + 공식 v4.3 보완 자료의 GLB 6개: 피부1, 골격·치아129, 근육·힘줄·근막437, 장기·부속67, 혈관56, 신경계·관련 공간340 (총1,030 메쉬)
- 인체 구조도 중심의 전체 화면과 떠 있는 도구 패널, 모바일 축약 패널, 호버·키보드·터치 조작
- 6계통 전환과 시점·표식 유지, 개별 불투명도, 회전·확대·이동, 정면·후면·측면, 경혈 확대
...
여섯 단계의 단독 보기, 레이어 조합·개별 불투명도, 구조 선택·확대·단독 보기, 앞쪽 메쉬 절개 보기를 제공합니다. 신규 레이어는 표시할 때 불러옵니다. 신경 모델은 뇌·척수 신경조직·뇌신경·일부 목과 상지의 말초신경을 포함합니다. 전신·양측 전체는 아닙니다. WASD/방향키 이동, Q/E 높이, Shift 빠른 이동, 휠 확대·축소 및 터치 이동 버튼을 지원합니다.
