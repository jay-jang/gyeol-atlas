...
- Z-Anatomy 계보의 전신 보완 레이어: 좌우 전신 신경525개 구성요소, 심혈관640개 구성요소. 1,165개 모두 영문명·편집 한국어명·TA2 라틴명·해부 계층으로 검색하고 클릭·확대·단독 보기 가능. 정확한 출처·해시·CC BY-SA 4.0 조건은 `data/catalog/full-system-supplement.json`에 기록
- 남성·여성 참조 전환과 전신/머리/상체/하체/팔·손/다리·발/가슴/배/골반 표시. 남성 림프142개와 NIH Human Reference Atlas 여성 참조264개(여성 림프5개 포함)를 실제 명명 노드로 검색·선택 가능. 여성 자료에 없는 근육·신경은 비활성화하며 완전한 여성 전신 모델로 표현하지 않음
- 인체 구조도 중심의 전체 화면과 떠 있는 도구 패널, 모바일 축약 패널, 호버·키보드·터치 조작
- 101단계 연속 박리와 7계통(체표·근육·골격·장기·혈관·림프·신경) 빠른 보기, 시점·표식 유지, 개별 불투명도, 회전·확대·이동, 정면·후면·측면, 경혈 확대
