...
- 남녀의 표시·검색·기관 묶음을 분리합니다. 여성은 NIH HRA 독립 전신 참조와 다른 여성 기증자의 하체 근육, 출처를 구분한 남성 유래 보완 골격으로 총1,220개 구조를 제공합니다. 7계통을 탐색할 수 있지만 위·상체 근육·일부 말초신경은 미수록이며 ‘전체 기관 완비’가 아닙니다. 여성 기관 대신 남성 기관을 표시하지 않습니다. [검증 및 한계](docs/anatomy-alignment/VERIFICATION.md)
