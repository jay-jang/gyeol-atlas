...
0~100 연속 박리 슬라이더는 체표를 걷고 437개 근육 메쉬를 표면 근접도 순으로 개별 페이드해 같은 근육계 안의 표층·중간·심부 관계를 드러냅니다. 깊어질수록 골격·장기·혈관·신경을 겹쳐 표시하며 계통 버튼은 단독 관찰을 위한 빠른 보기로 남깁니다. 이 순서는 메쉬 공간 관계에서 계산한 학습용 시각화이지 전문가가 분류한 해부학적 층판이나 수술 절개 경로가 아닙니다. 어두운 관찰 배경에 피부색, 근육 적색, 골격 상아색, 동맥 적색·정맥 청색, 신경 황색의 의학 아틀라스 관례 팔레트를 사용합니다.
