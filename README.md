...
- 남성·여성 참조 전환과 전신/머리/상체/하체/팔·손/다리·발/가슴/배/골반 표시. 여성 보기에는 NIH Human Reference Atlas 여성 고유264개(여성 림프5개 포함)를 성별 공통 전신 해부2,486개와 정렬해 합성하여 7개 계통 모두를 탐색 가능. 공통 보완 구조는 여성 전용 원본으로 오인하지 않도록 검색 결과에 구분 표시
